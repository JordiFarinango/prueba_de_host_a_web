...
=======
    $first = true; // Variable para rastrear el primer campo habilitado
    $presentation_number = 1; // Variable para numerar las presentaciones
>>>>>>> 4ec66a0c3ac98e6ef533179bce9243f25a3d9322
...
=======
                $html .= "<td class='{$extraClass}'>{$parametro['nombre']}<br><input type='number' name='nota_{$id_parametro}' id='nota_{$id_parametro}' value='{$nota}' min='{$min}' max='{$max}' required {$disabled}>";
>>>>>>> 4ec66a0c3ac98e6ef533179bce9243f25a3d9322
